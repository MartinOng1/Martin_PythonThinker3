...
# ============================================================
    ...
    if customer_spending[customer] > 1000:
        vip[customer] = customer_spending[customer]
        print(f"Hi {customer}, you are now a VIP! Congratulations!")
    else:
        non_vip[customer] = customer_spending[customer]
        print(f"Hi {customer}, spend ${1000-customer_spending[customer]} to become a VIP member!")
